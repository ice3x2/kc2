...
> 2026-09-08: Continuous-web r5 supersedes the construction/desk-foot description
> below. Use [current print and assembly instructions](PRINT-r5.md).
> The former 1 mm air gap is removed; component reliefs remain open upward.
> Below is historical design context, not current printability evidence.
