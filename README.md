...
- [연속 벽 상·하판 인쇄 안내](hardware/MODELS/PRINT-enclosed.md) · [게시 manifest](hardware/MODELS/kc2_enclosure_manifest.json) · [검증 기록](docs/reports/enclosed-housing-20260909/README.md)
