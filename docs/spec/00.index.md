...
| kc2-x3-v2 | hardware-variant | active | KC2 71-key stabilizer-free Choc V2 socket and MX solder board with concealed bezel, tight join, and load-bearing housing support |
