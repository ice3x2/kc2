...
class LeftCentralProducerTests(unittest.TestCase):
    ...
    def test_exact_change_protects_full_old_stock_and_male(self):
        ...
        after,audit=apply_relief(before,[cutter],base,male)
        ...
        for bad in (base,male):
            with self.assertRaises(ValueError):apply_relief(before,[bad],base,male)
        with self.assertRaises(ValueError):apply_relief(before,[],base,male)
