...
EXPECTED_BOARD_CANONICAL_SHA256 = {
    "left": "7f629b7f48c7432ddc34429b12d7883a2fd1389a40187b2eeb93d549fba1be6d",
    "right": "4500956acec4e9f8ada2da285d9fad6c6accad5263da9128d0a14d300af3209c",
}
    ...
    *,
    ...
    for side in ("left", "right"):
        ...
        if enforce_release_board_hashes and canonical_sha != EXPECTED_BOARD_CANONICAL_SHA256[side]:
            errors.append(f"{side}: source board is not the final CON-ARCH-006/007 P1 board")
    ...
    if actual_mount_centers != EXPECTED_MOUNT_CENTERS_MM:
        errors.append("source board: mounting centers do not match final CON-ARCH-006 P1")
