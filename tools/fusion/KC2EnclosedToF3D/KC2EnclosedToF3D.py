"""CON-ARCH-006: actual native exports/reopens, staged enclosed variants only."""
...
def run(context='all'):
    ...
    folder=root/'.codex-tmp/enclosure-build'
    ...
    try:
        ...
        for label,source in jobs.items():
            ...
            for i,body in enumerate(bodies):body.name=f'KC2 enclosed {label} part{i+1}'
